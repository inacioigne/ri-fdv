...
@listableObjectComponent('PublicationSearchResult', ViewMode.ListElement, Context.Any, 'fdv')
@listableObjectComponent(ItemSearchResult, ViewMode.ListElement, Context.Any, 'fdv')
@Component({
